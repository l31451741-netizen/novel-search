...
**核心功能亮点**：
- 💡 **顶部防迷路公告条**：实时展示微信公众号与微博引导。
- 📌 **吸顶固定搜索栏**：页面滚动时搜索框自动吸顶，随时随地便捷搜索。
- 🛡️ **全局防搬运暗纹水印**：页面背景自带半透明防搬运浮动水印。
- 👥 **作者合集与分页**：支持作者作品聚合展示及展开/收起全部书籍。
- 💬 **求书留言反馈**：支持前台提交求书、查看留言处理状态（待处理/已采纳/已补充/已拒绝）。
- 🚀 **右下角悬浮求书按钮**：一键直达留言区。
...
| `tab` | string | 标签页：`hot`(热门)、`featured`(精选)、`authors`(作者合集)、`latest`(最新) |
